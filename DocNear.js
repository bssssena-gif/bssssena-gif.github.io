...
function redirectRole(role){
  const r={patient:"patientDash",doctor:"doctorDash",store:"storeDash",ambulance:"ambuDash",lab:"labDash",hospital:"hospitals",homeprovider:"home_providers",admin:null};
